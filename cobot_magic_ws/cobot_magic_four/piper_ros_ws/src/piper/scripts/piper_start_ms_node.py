...
class C_PiperRosNode():
    ...
    def PublishSlaveArmJointAndGripper(self):
        ...
        joint_0:float = (self.piper.GetArmJointMsgs().joint_state.joint_1/1000) * math.pi / 180
        joint_1:float = (self.piper.GetArmJointMsgs().joint_state.joint_2/1000) * math.pi / 180
        joint_2:float = (self.piper.GetArmJointMsgs().joint_state.joint_3/1000) * math.pi / 180
        joint_3:float = (self.piper.GetArmJointMsgs().joint_state.joint_4/1000) * math.pi / 180
        joint_4:float = (self.piper.GetArmJointMsgs().joint_state.joint_5/1000) * math.pi / 180
        joint_5:float = (self.piper.GetArmJointMsgs().joint_state.joint_6/1000) * math.pi / 180
    ...
    def PublishMasterArmJointAndGripper(self):
        ...
        joint_0:float = (self.piper.GetArmJointCtrl().joint_ctrl.joint_1/1000) * math.pi / 180
        joint_1:float = (self.piper.GetArmJointCtrl().joint_ctrl.joint_2/1000) * math.pi / 180
        joint_2:float = (self.piper.GetArmJointCtrl().joint_ctrl.joint_3/1000) * math.pi / 180
        joint_3:float = (self.piper.GetArmJointCtrl().joint_ctrl.joint_4/1000) * math.pi / 180
        joint_4:float = (self.piper.GetArmJointCtrl().joint_ctrl.joint_5/1000) * math.pi / 180
        joint_5:float = (self.piper.GetArmJointCtrl().joint_ctrl.joint_6/1000) * math.pi / 180
    ...
    def joint_callback(self, joint_data):
        ...
        Args:
            joint_data (): 
        """
        factor = 1000 * 180 / math.pi #1000*180/3.14
        factor1 = 57.32484
        print(self.can_port)
